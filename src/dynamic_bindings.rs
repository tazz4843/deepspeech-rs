...
impl LibraryWrapper {
    ...
    pub unsafe fn DS_FinishStreamWithMetadata(
        ...
        let dyn_symbol =
            self.inner.get::<unsafe extern "C" fn(
                *mut StreamingState,
                ::std::os::raw::c_uint,
            ) -> *mut Metadata>(b"DS_FinishStreamWithMetadata\0")?;
        ...
        let dyn_symbol =
            self.inner.get::<unsafe extern "C" fn(
                *const StreamingState,
                ::std::os::raw::c_uint,
            ) -> *mut Metadata>(b"DS_IntermediateDecodeWithMetadata\0")?;
        Ok(dyn_symbol(aSctx, aNumResults))
    }
    ...
    pub unsafe fn DS_ClearHotWords(
        &self,
        aCtx: *mut ModelState,
    ) -> Result<::std::os::raw::c_int, libloading::Error> {
        let dyn_symbol =
            self.inner
                .get::<unsafe extern "C" fn(*mut ModelState) -> ::std::os::raw::c_int>(
                    b"DS_ClearHotWords\0",
                )?;
        Ok(dyn_symbol(aCtx))
    }
    pub unsafe fn DS_EraseHotWord(
        &self,
        aCtx: *mut ModelState,
        ...
        ) -> ::std::os::raw::c_int>(b"DS_EraseHotWord\0")?;
        Ok(dyn_symbol(aCtx, word))
    }
    pub unsafe fn DS_AddHotWord(
        &self,
        aCtx: *mut ModelState,
        word: *const ::std::os::raw::c_char,
        boost: f32,
        ...
        let dyn_symbol = self.inner.get::<unsafe extern "C" fn(
            ...
            *const ::std::os::raw::c_char,
            f32,
        ) -> ::std::os::raw::c_int>(b"DS_AddHotWord\0")?;
